...
import { TextInput as RNTextInput, StyleSheet, View, TouchableOpacity, TextInputProperties } from 'react-native'
import styled from 'styled-components/native'

const TEXT_DARK_COLOR = '#484747'
const TEXT_LIGHT_COLOR = '#FFFFFF'

export interface ILightThemeInterface {
  dark: boolean
}
...
const Wrapper = styled(View)`
  ...
  border-bottom-color: ${(props: ILightThemeInterface) => props.dark ? TEXT_DARK_COLOR : TEXT_LIGHT_COLOR};
  flex-direction: row;
  align-items: center;
`
const StyledTextInput = styled(RNTextInput)`
  ...
  color: ${(props: ILightThemeInterface) => props.dark ? TEXT_DARK_COLOR : TEXT_LIGHT_COLOR};
...
export interface ITextInputProps extends TextInputProperties {
  leftIcon?: any,
  rightIcon?: any,
